...
export default function RegisterPage() {
  ...
  if (success) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#1c1c1c] p-8 text-slate-200">
        <div className="w-full max-w-[420px] rounded-xl border border-white/10 bg-[#242424] p-10 text-center shadow-2xl">
          ...
          <h2 className="mb-3 text-2xl font-semibold text-white">Cek Email Anda!</h2>
          <p className="mb-8 text-sm leading-relaxed text-slate-400">
            Kami telah mengirimkan link konfirmasi ke <strong className="text-white">{email}</strong>.
            Klik link tersebut untuk mengaktifkan akun Anda.
          </p>
          <Link 
            href="/login" 
            className="block w-full rounded-md bg-white px-4 py-3 text-sm font-semibold text-black transition-colors hover:bg-slate-200"
          >
